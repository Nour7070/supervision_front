...
import ReactPaginate from 'react-paginate';
import axios from 'axios';
import { FiSearch, FiUserPlus, FiBarChart2, FiFilter, FiChevronUp, FiChevronDown } from 'react-icons/fi';
import '../styles/ModerateursListe.css';
...
const ModerateursListe = ({ userType }) => {
  ...
  const sortedModerateurs = React.useMemo(() => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <h1 className="text-2xl md:text-3xl font-bold mb-6 text-center text-teal-700">Gestion des Modérateurs</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
        ...
        <div className="bg-gradient-to-r from-teal-100 to-teal-50 border border-teal-200 rounded-lg p-2 md:p-2 text-center cursor-default flex-shrink-0">
          <span className="font-medium text-teal-800">Total: {filteredModerateurs.length}</span>
        </div>
      </div>
              ...
              >
                ...
                <td className="text-center py-3 px-4">
                  <div className="flex flex-wrap justify-center gap-1">
                    {moderateur.permissions.map((perm, idx) => (
