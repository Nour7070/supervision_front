    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      {userType === 'SUPERVISEUR' && (
        <div className="mt-6 text-center">
          <Link
            to="/moderateurs/add"
            className="bg-[#938A8A] text-black py-2 px-6 rounded-lg hover:from-teal-700 hover:to-teal-600 shadow-md hover:shadow-lg transition-all duration-200 inline-flex items-center"
          >
