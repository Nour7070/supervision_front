                            ...
                            <motion.div className="space-y-3" {...animationProps}>
                                {(showAllCourses ? stats.pendingCourseSubmissions : stats.pendingCourseSubmissions.slice(0, 2)).map((course) => (
                                    ...
                                    <input
                                      ...
                                      className="form-checkbox h-4 w-4 border-2 border-[#FACC15] bg-white text-[#FACC15] rounded focus:ring-[#FACC15] focus:ring-offset-0 focus:ring- checked:bg-[#FACC15] checked:border-[#FACC15] mr-3"
                                    />
                                        <div className="flex-1 flex justify-between items-center">
                                            <div>
