...
const Layout = ({ onLogout }) =>
{
  ...
  useEffect(() => {
    ...
    if (userEmail) {
      // Appeler l'API pour récupérer le userType
      fetch(`http://votre-api/api/users/info?email=${encodeURIComponent(userEmail)}`)
        .then(response => {
          if (response.ok) {
      ...
      // Si pas d'email stocké, rediriger vers la page de connexion
      window.location.href = '/login';
    }
  }, []);
