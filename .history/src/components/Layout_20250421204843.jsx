...
const Layout = ({ onLogout }) =>
{
  ...
  return (
    <div className="flex h-screen bg-gray-100 z-20">
      <div className={`hidden md:flex md:flex-shrink-0 ${sidebarOpen ? 'w-64' : 'w-12'} bg-[#034732] transition-all duration-300 flex-col`}>
        <div className="flex items-center justify-center h-10 flex-shrink-0 px-4 bg-[#034732] z-20">
          {sidebarOpen ? (
