...
const UserStat = () => {
    ...
    const getFormateurChartData = () => {
        ...
        const domainData = stats.coursParCategorie 
        ...
        return { 
            progressData: [
                { name: 'Courses', publiés: stats.coursPublies, enAttente: stats.coursEnAttente }
            ],
            domainData 
        };
    };
                        ...
                        <>
                            <motion.div variants={itemVariants} className="bg-white p-6 rounded-xl shadow-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-gray-500">Courses approved</h3>
                            ...
                            <motion.div variants={itemVariants} className="bg-white p-6 rounded-xl shadow-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-gray-500">Courses pending</h3>
                            ...
                            <motion.div variants={itemVariants} className="bg-white p-6 rounded-xl shadow-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-gray-500">Last course</h3>
                    ...
                    <motion.div variants={itemVariants}>
                        <div className="bg-white rounded-xl shadow-lg p-6 h-full">
                            <h2 className="text-2xl font-semibold text-gray-800 mb-6">
                                {userType === 'FORMATEUR' ? 'Courses' : 'Progression par domaine'}
                            </h2>
                            <div className="h-80">
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    {userType === 'FORMATEUR' ? (
                                        <BarChart data={formateurCharts?.progressData}>
                                            ...
                                            <Tooltip />
                                            <Legend />
                                            <Bar dataKey="publiés" fill="#057652" name="Courses approved" />
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 h-full">
        ...
        {formateurCharts?.domainData?.length > 0 ? (
            <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                        <Pie
                            data={formateurCharts.domainData}
                            cx="50%"
                            cy="50%"
                            labelLine={false}
                            outerRadius={80}
                        ...
                        >
                            {formateurCharts.domainData.map((entry, index) => (
