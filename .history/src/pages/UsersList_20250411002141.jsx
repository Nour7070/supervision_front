...
const UsersList = ({ userType }) =>
{
    ...
    return (
        ...
        <div 
            ...
            style={{
                backgroundImage: 'url(/images/coran.jpg)', // Remplacez par le chemin de votre image
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat',
                opacity: '0.15', // Ajustez l'opacité selon vos besoins (0.1 à 0.3 est généralement bon)
            }}
        ></div>
