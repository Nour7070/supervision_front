              ...
              currentItems.map((moderateur) => (
                ...
                >
                  ...
                  <td className="text-center py-3 px-4 space-x-2">
                    <button
                      className="bg-gray-200 text-black py-1 px-3 rounded-lg hover:bg-gray-300 transition-all duration-200 flex items-center space-x-1"
                      onClick={() => handleViewStats(moderateur.id)}
                    >
                      <FiBarChart2 size={16} />
                      <span>Stats</span>
                    ...
                    {userType === 'SUPERVISEUR' && (
                      <button
                        className="bg-red-100 text-red-600 py-1 px-3 rounded-lg hover:bg-red-200 transition-all duration-200 flex items-center space-x-1"
                        onClick={() => handleDeleteModerator(moderateur.id)}
                      >
                        <FiTrash2 size={16} />
                        <span>Delete</span>
                      </button>
