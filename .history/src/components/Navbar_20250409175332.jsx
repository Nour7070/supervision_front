          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <button
                ...
                className="p-1 text-gray-500 rounded-full hover:bg-white-100 focus:outline-none transition-colors"
            ...
            <div className="relative flex items-center space-x-3">
              ...
              <div className="h-8 w-8 rounded-full bg-white-200 flex items-center justify-center">
