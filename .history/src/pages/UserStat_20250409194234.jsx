...
const UserStats = () =>
{
    ...
    useEffect(() =>
    {
        // Simuler la récupération des statistiques après 1 seconde
        setTimeout(() =>
        {
            const simulatedData = {
                name: 'John Doe',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {userType === 'FORMATEUR' ? (
                    <>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            <h2 className="text-xl font-semibold mb-2">Plaintes reçues</h2>
                            <p>{stats.plaintes}</p>
                        </div>
                    </>
                ) : (
                    <>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            <h2 className="text-xl font-semibold mb-2">Plaintes déposées</h2>
                            <p>{stats.plaintesDeposees}</p>
                        </div>
                    </>
                )}
            </div>
