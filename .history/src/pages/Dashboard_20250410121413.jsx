...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        ...
        { mois: 'Avr', Fiqh: 50, Ahkam: 70, History: 47, Quran: 10, Sira: 35 },
        { mois: 'Mai', Fiqh: 102, Ahkam: 120, History: 70, Quran: 20, Sira: 40 },
        { mois: 'Juin', Fiqh: 80, Ahkam: 50, History: 80, Quran: 25, Sira: 45 },
        { mois: 'Juil', Fiqh: 100, Ahkam: 75, History: 30, Quran: 55, Sira: 50 },
        { mois: 'Août', Fiqh: 90, Ahkam: 65, History: 50, Quran: 70, Sira: 45 },
        { mois: 'Sep', Fiqh: 120, Ahkam: 90, History: 65, Quran: 100, Sira: 55 },
