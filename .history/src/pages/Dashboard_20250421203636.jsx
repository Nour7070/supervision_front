...
const formatTimeAgo = (timestamp) => {
    ...
    useEffect(() => {
      ...
      // Récupérer les documents pour chaque formateur
            ...
            documents: docsResponse.data
                ...
                setStats({
                    ...
                    pendingRegistrations: pendingFormateursWithDocs.map(f => ({
                        ...
                        email: f.email,
                        phone: f.phoneNumber || "N/A",
                        documents: f.documents || [], // Ajout des documents
                        experience: f.experience || "Non spécifiée",
                        date: new Date().toISOString().split('T')[0]
                      })),
    ...
    /*const handlePreviewFile = (filename) => {
        const fileUrl = `http://localhost:8081/api/file-content/${encodeURIComponent(filename)}`;
    ...
    const handlePreviewFile = (filePath) => {
        ...
        // Si c'est un PDF ou une image, ouvrir dans un nouvel onglet
    ...
    const fetchFormateurDocuments = async (formateurId) => {
      ...
      const handleViewFormateur = async (formateur) => {
        setLoading(true);
        try {
          const documents = await fetchFormateurDocuments(formateur.id);
    ...
    <div className="space-y-4">
        <div className="flex items-center">
            <div className="w-1/4 text-sm text-gray-600 pr-3">Formateurs</div>
        ...
        <div className="flex items-center">
            <div className="w-1/4 text-sm text-gray-600 pr-3">Apprenants</div>
            <div className="w-full bg-gray-200 rounded-full h-3">
                <div
        ...
        {userType?.toUpperCase() === 'SUPERVISEUR' && (
            <div className="flex items-center">
                <div className="w-1/4 text-sm text-gray-600 pr-3">Modérateurs</div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                    <button 
        onClick={() => handlePreviewFile(selectedCourse.file)}
