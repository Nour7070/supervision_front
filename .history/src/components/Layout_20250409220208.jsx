...
const Layout = ({ onLogout }) =>
{
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`hidden md:flex md:flex-shrink-0 ${sidebarOpen ? 'w-64' : 'w-20'} bg-[#E8F4F0] transition-all duration-300 flex-col`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className=" bg-[#0B3619] shadow-sm z-10">
