...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        { mois: 'Jan', Fiqh: 65, Ahkam: 45, History: 30, design: 25, langues: 20 },
        { mois: 'Fév', Fiqh: 70, Ahkam: 50, History: 35, design: 30, langues: 25 },
        { mois: 'Mar', Fiqh: 80, Ahkam: 55, History: 40, design: 35, langues: 30 },
        { mois: 'Avr', Fiqh: 90, Ahkam: 60, History: 45, design: 40, langues: 35 },
        { mois: 'Mai', Fiqh: 85, Ahkam: 65, History: 50, design: 45, langues: 40 },
        { mois: 'Juin', Fiqh: 95, Ahkam: 70, History: 55, design: 50, langues: 45 },
        { mois: 'Juil', Fiqh: 100, Ahkam: 75, History: 60, design: 55, langues: 50 },
        { mois: 'Août', Fiqh: 90, Ahkam: 65, History: 50, design: 45, langues: 45 },
        { mois: 'Sep', Fiqh: 110, Ahkam: 80, History: 65, design: 60, langues: 55 },
        { mois: 'Oct', Fiqh: 120, Ahkam: 85, History: 70, design: 65, langues: 60 },
        { mois: 'Nov', Fiqh: 115, Ahkam: 80, History: 65, design: 60, langues: 55 },
        { mois: 'Déc', Fiqh: 130, Ahkam: 90, History: 75, design: 70, langues: 65 },
    ];
