...
>
    ...
    {/* Images décoratives positionnées comme dans le Profile */}
    <img 
        src="/images/Subtract" 
        alt="Design Element" 
        className="absolute -top-4 right-4 h-32 w-auto opacity-80 z-0"
    />
    <img 
        src="/images/Subtract" 
        alt="Design Element" 
        className="absolute left-3 -bottom-4 h-32 w-auto opacity-60 z-0 transform scale-x-[-1]"
    />
    ...
    <div className="relative z-10">
        <div className="flex flex-col items-center text-center">
            ...
            <div className="h-1 w-16 bg-[#FACC15] mx-auto rounded-full my-2"></div>
