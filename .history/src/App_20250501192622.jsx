...
import TrainerRequestsTable from './components/TrainerRequestsTable';
    ...
    <Router>
      <Routes>
        <Route path="/" element={<Layout userType={userType} onLogout={() => { }} />}>
          ...
          <Route path="/admin/trainer-requests" element={<TrainerRequestsTable requests={stats.pendingRegistrations} />} />
<Route path="/admin/course-requests" element={<CourseRequestsTable courses={stats.pendingCourseSubmissions} />} />
        </Route>
      </Routes>
    </Router>
  );
    ...
    <Router>
      <Routes>
        <Route path="/" element={<Layout userType={userType} onLogout={() => {
          ...
          * Route pour les statistiques des utilisateurs (commune) *
          <Route path="/users/:userType/:id/stats" element={<UserStat />} />
          
          * Fallback pour les accès non autorisés *
          <Route path="/unauthorized" element={<Unauthorized />} />
