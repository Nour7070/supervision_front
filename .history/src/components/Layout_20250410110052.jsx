      ...
      <div className={`hidden md:flex md:flex-shrink-0 ${sidebarOpen ? 'w-64' : 'w-20'} bg-[#034732] transition-all duration-300 flex-col`}>
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="px-2 py-4">
            <Link
              to="/dashboard"
              className="flex items-center px-4 py-3 text-indigo-100 hover:bg-[#034732] rounded-lg group"
            >
            ...
            {userType === "SUPERVISEUR" && (
              <Link
                to="/moderateurs"
                className="flex items-center px-4 py-3 text-indigo-100 hover:bg-[#02271B] rounded-lg group"
              >
            ...
            <button
              onClick={onLogout}
              className="w-full flex items-center px-4 py-3 text-indigo-100 hover:bg-indigo-600 rounded-lg group mt-4"
            >
      ...
      <div className={`fixed inset-y-0 left-0 z-20 w-64 bg-indigo-700 transform ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transition-transform duration-300`}>
        ...
        <nav className="px-2 py-4">
          ...
          <button
            ...
            className="w-full flex items-center px-4 py-3 text-indigo-100 hover:bg-indigo-600 rounded-lg mt-4"
          >
