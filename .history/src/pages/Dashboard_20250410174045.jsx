    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="bg-white p-8 rounded-lg shadow-lg mb-6">
                ...
                {/* Troisième ligne : Demandes côte à côte */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    {/* Demandes d'inscription Formateurs */}
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                        <h2 className="text-base font-semibold mb-3">Demandes d'inscription Formateurs</h2>
                        <AnimatePresence>
                            <motion.div
                        ...
                        {stats.pendingRegistrations.length > 2 && (
                            <div
                                ...
                                onClick={() => setShowAll(!showAll)}
                            >
                                {showAll ? <><FiChevronUp size={16} /> Voir moins</> : <><FiChevronDown size={16} /> Voir toute la liste</>}
                            </div>
                        )}
                    </div>

                    {/* Demandes de publication Cours */}
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                        <h2 className="text-base font-semibold mb-3">Demandes de publication Cours</h2>
                        <AnimatePresence>
                            <motion.div
                        ...
                        {stats.pendingCourseSubmissions.length > 2 && (
                            <div
                                ...
                                onClick={() => setShowAllCourses(!showAllCourses)}
                            >
                                {showAllCourses ? <><FiChevronUp size={16} /> Voir moins</> : <><FiChevronDown size={16} /> Voir toute la liste</>}
                            </div>
                        )}
                    </div>
                </div>
