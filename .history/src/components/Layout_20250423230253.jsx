...
<div className={`fixed inset-y-0 left-0 z-20 w-75 bg-[#034732] transform ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transition-transform duration-300`}>
