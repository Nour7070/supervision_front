...
{
  // Données statiques pour les validations de cours
  const [validations, setValidations] = useState([
    { id: 1, coursNom: "Introduction à React", formateurId: 101, status: "En attente" },
    { id: 2, coursNom: "JavaScript Avancé", formateurId: 102, status: "En attente" },
    { id: 3, coursNom: "Bases de données NoSQL", formateurId: 103, status: "En attente" },
    { id: 4, coursNom: "Développement Frontend", formateurId: 101, status: "En attente" },
    { id: 5, coursNom: "Architecture Microservices", formateurId: 104, status: "En attente" }
  ]);
  ...
  const handleAction = (id, action) =>
  {
    ...
    setValidations(prevValidations =>
      prevValidations.filter(validation => validation.id !== id)
    );
  };
