...
const Maps = () => {
    ...
    const colorScale = scaleLinear()
        .domain([0, 5000])
        .range(["#e5f1ed", "#034732"]) // De très pâle à foncé
                ...
                <Geographies geography={worldGeoJson}>
                    {({ geographies }) =>
                        geographies.map((geo) => {
                            ...
                            // Tous les pays ont au moins une teinte très légère
                            const fillColor = users > 0 ? colorScale(users) : colorScale(50);
                            ...
                            return (
                                <Geography
                                    ...
                                    style={{
                                        default: { outline: 'none' },
                                        hover: { fill: '#01321f', outline: 'none' }, // Version plus foncée au hover
                                        pressed: { outline: 'none' }
                                    }}
                                />
                            );
