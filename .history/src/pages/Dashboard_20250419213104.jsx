...
const [selectAllCourses, setSelectAllCourses] = useState(false);
    ...
    const toggleAllRegistrations = () => {
        if (selectAllRegistrations) {
            ...
            setSelectedRegistration(stats.pendingRegistrations.map(r => r.id));
        }
    ...
    const toggleAllCourses = () => {
        if (selectAllCourses) {
            ...
            setSelectedCourse(stats.pendingCourseSubmissions.map(c => c.id));
        }
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                    <button 
    onClick={() => handlePreviewChapter(chapter.fileUrl)}
