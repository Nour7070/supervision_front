...
import { CheckCircle, Clock, Book, Award, Users, AlertCircle , ArrowLeft} from 'lucide-react';
...
const UserStat = () => {
    ...
    return (
      ...
      />
        ...
        <motion.button
                    onClick={handleBack}
                    className="fixed top-6 left-6 z-20 flex items-center gap-2 bg-white/80 backdrop-blur-sm hover:bg-white px-4 py-2 rounded-full shadow-md transition-colors duration-300 border border-gray-200"
            ...
            <motion.div 
    className="relative rounded-xl shadow-lg p-6 mb-8 overflow-hidden "
    variants={itemVariants}
>
            <motion.div 
...
>
    ...
    <div className="absolute left-0 top-0 h-48 w-48 overflow-hidden z-0 opacity-60">
        <img 
    ...
    <div className="absolute right-0 bottom-0 h-48 w-48 overflow-hidden z-0 opacity-60">
        <img 
            src="/images/Subtract.png" 
            alt=""
            className="h-full w-full object-contain"
        ...
        <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-4 text-white/90">
                ...
                <div className="bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
                    <span>
                        {userType === 'FORMATEUR' 
                            ? `${stats?.etudiantsAbonnes} students` 
                                    ...
                                    <div className="h-80">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <BarChart data={formateurCharts?.progressData}>
                                                ...
                                                <Tooltip />
                                                <Legend />
                                                <Bar dataKey="publiés" fill="#52b788" name="Approved"  barSize={90} />
                                                <Bar dataKey="enAttente" fill="#B0F2B4" name="Pending"  barSize={90} />
                                            </BarChart>
                                        </ResponsiveContainer>
                                    </div>
                                </div>
