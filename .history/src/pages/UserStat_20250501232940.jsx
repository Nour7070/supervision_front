...
>
    ...
    <div className="absolute left-2 top-2 h-32 w-32 overflow-hidden z-0 opacity-60">
        <img 
    ...
    <div className="absolute right-4 bottom-2 h-32 w-32 overflow-hidden z-0 opacity-60">
        <img 
            src="/images/Subtract.png" 
            alt=""
            className="h-full w-full object-contain"
