...
>
    {/* Fond dégradé avec opacité */}
    <div className="absolute inset-0 bg-gradient-to-r from-[#034732]/90 to-[#056349]/80 z-0"></div>
    
    {/* Images décoratives des deux côtés */}
    <img 
        src="/images/Subtract" 
        alt="Decoration"
        className="absolute right-0 top-0 h-full opacity-30 z-0"
        style={{ transform: 'translateX(30%)' }}
    />
    <img 
        src="/images/Subtract" 
        alt="Decoration"
        className="absolute left-0 top-0 h-full opacity-30 z-0"
        style={{ transform: 'scaleX(-1) translateX(30%)' }}
    />
