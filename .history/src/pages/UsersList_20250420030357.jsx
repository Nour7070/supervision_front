    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <h1 className="text-2xl font-bold mb-6">
                Statistiques de {userType === "FORMATEUR" ? "Formateur" : "Apprenant"}
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {userType === "FORMATEUR" ? (
                    <>
                        <StatBox title="Cours Publiés" value={stats.coursPublies || 0} />
                        <StatBox title="Cours en Attente" value={stats.coursEnAttente || 0} />
                        <StatBox title="Étudiants Inscrits" value={stats.etudiantsAbonnes || 0} />
                    </>
                ) : (
                    <>
                        <StatBox title="Cours Suivis" value={(stats.coursSuivis || []).length} />
                        <StatBox title="Taux de Complétion" value={(stats.tauxCompletion || 0) + "%"} />
                        <StatBox title="Formateurs Suivis" value={stats.formateursSuivis || 0} />
                    </>
                )}
            </div>
