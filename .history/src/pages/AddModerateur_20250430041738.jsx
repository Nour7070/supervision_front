...
const AddModerateur = () => {
    ...
    return (
        <div className="relative min-h-screen"> {/* Changé ici */}
        <div className="fixed inset-0 z-0"  {/* Retiré -z-10 */}
          style={{ 
        ...
        <div className="relative z-10 flex items-center justify-center p-4"> {/* Ajouté relative z-10 */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-2 space-y-3">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gray-200 text-black py-2.5 rounded-lg hover:bg-gray-300 transition-all shadow-md flex items-center justify-center"
                        >
                            {loading ? (
