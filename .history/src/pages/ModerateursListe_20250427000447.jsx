...
const ModerateursListe = ({ userType }) => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
     ...
     style={{ 
       backgroundImage: 'url(/images/images/Screenshot_2181.jpg)', 
                ...
                >
                  ...
                  <td className="text-center py-3 px-4">
                    <div className="flex justify-center space-x-2">
                      ...
                      {userType === 'SUPERVISEUR' && (
                        <button
                          className="bg-white text-black border border-gray-500 py-1 px-3 rounded-lg hover:bg-gray-200 transition-all duration-200 flex items-center"
