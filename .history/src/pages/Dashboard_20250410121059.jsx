...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        { mois: 'Jan', Fiqh: 65, Ahkam: 45, History: 30, Quran: 25, Sira: 20 },
        { mois: 'Fév', Fiqh: 70, Ahkam: 50, History: 35, Quran: 30, Sira: 25 },
        { mois: 'Mar', Fiqh: 90, Ahkam: 55, History: 40, Quran: 35, Sira: 30 },
        { mois: 'Avr', Fiqh: 50, Ahkam: 60, History: 45, Quran: 40, Sira: 35 },
        { mois: 'Mai', Fiqh: 102, Ahkam: 65, History: 50, Quran: 45, Sira: 40 },
        { mois: 'Juin', Fiqh: 95, Ahkam: 70, History: 55, Quran: 50, Sira: 45 },
        { mois: 'Juil', Fiqh: 100, Ahkam: 75, History: 60, Quran: 55, Sira: 50 },
        { mois: 'Août', Fiqh: 90, Ahkam: 65, History: 50, Quran: 45, Sira: 45 },
        { mois: 'Sep', Fiqh: 110, Ahkam: 80, History: 65, Quran: 60, Sira: 55 },
        { mois: 'Oct', Fiqh: 120, Ahkam: 85, History: 70, Quran: 65, Sira: 60 },
        { mois: 'Nov', Fiqh: 115, Ahkam: 80, History: 65, Quran: 60, Sira: 55 },
        { mois: 'Déc', Fiqh: 130, Ahkam: 90, History: 75, Quran: 70, Sira: 65 },
    ];
