    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="bg-white p-8 rounded-lg shadow-lg mb-6">
                ...
                {/* Deuxième ligne : Colonne gauche et droite */}
                <div className="flex flex-col lg:flex-row gap-6">
                    {/* Colonne de gauche - réduite */}
                    <div className="lg:w-[65%] space-y-4">
                        {/* Chacun des 4 blocs ici, avec padding réduit */}
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm text-sm">
                            <h2 className="text-lg font-semibold mb-3">Utilisateurs par type</h2>
                            <div className="space-y-4">
                                <div className="flex items-center">
                                    <div className="w-full bg-white-200 rounded-full h-3">
                                        <div
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm text-sm">
                            <h2 className="text-lg font-semibold mb-3">Demandes d'inscription Formateurs</h2>
                            <div className="space-y-3">
                                {stats.pendingRegistrations.map(request => (
                                    <div key={request.id} className="border-b pb-3 last:border-0">
                                        <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm text-sm">
                            <h2 className="text-lg font-semibold mb-3">Demandes de publication Cours</h2>
                            <div className="space-y-3">
                                {stats.pendingCourseSubmissions.map(course => (
                                    <div key={course.id} className="border-b pb-3 last:border-0">
                                        <div className="flex justify-between items-center">
