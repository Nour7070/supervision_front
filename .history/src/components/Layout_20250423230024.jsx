...
const Layout = ({ onLogout }) =>
{
  ...
  return (
    <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${mobileSidebarOpen ? 'ml-64' : 'ml-0'} md:ml-0`}>
      <div className={`hidden md:flex md:flex-shrink-0 ${sidebarOpen ? 'w-64' : 'w-12'} bg-[#034732] transition-all duration-300 flex-col z-20 `}>
...
<div className={`fixed inset-y-0 left-0 z-20 w-64 bg-[#034732] transform ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transition-transform duration-300`}>
    <div className="flex items-center justify-between h-10 px-4 bg-[#034732]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        className="md:hidden text-white p-1 rounded-md hover:bg-[#07885F] mr-2"
      >
        <FiMenu size={24} />
      </button>
              <button
