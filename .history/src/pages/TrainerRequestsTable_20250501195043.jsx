...
const TrainerRequestsTable = () => {
  ...
  return (
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
     ...
     <div>  <h2 className="text-xl font-semibold mb-6">Trainer Registration Requests</h2> </div> 
            ...
            {requests.map((request) => (
              <tr key={request.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  ...
                  <button 
                    onClick={() => handleApproveRegistration(request.email)}
                    className="text-green-600 hover:text-green-900 mr-3"
                  >
                    Approve
                  </button>
                  <button 
                    onClick={() => handleRejectRegistration(request.email)}
