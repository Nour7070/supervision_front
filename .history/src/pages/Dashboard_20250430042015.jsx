...
/*const handlePreviewFile = (fileUrl) => {
    ...
    return (
        <div className="relative min-h-screen"> {/* Conteneur principal */}
  {/* Image de fond - en premier dans le flux */}
  <div className="fixed inset-0 z-0"  {/* z-0 au lieu de -z-10 */}
    style={{ 
  ...
  {/* Contenu principal - avec z-10 pour s'afficher par-dessus */}
  <div className="relative z-10 p-6"> {/* Ajout de relative z-10 */}
