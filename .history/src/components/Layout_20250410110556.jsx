...
const Layout = ({ onLogout }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`fixed inset-y-0 left-0 z-20 w-64 bg-034732-700 transform ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transition-transform duration-300`}>
