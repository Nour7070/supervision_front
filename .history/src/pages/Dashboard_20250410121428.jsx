...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        ...
        { mois: 'Oct', Fiqh: 70, Ahkam: 65, History: 90, Quran: 50, Sira: 60 },
        { mois: 'Nov', Fiqh: 90, Ahkam: 45, History: 100, Quran: 70, Sira: 55 },
        { mois: 'Déc', Fiqh: 50, Ahkam: 90, History: 75, Quran: 55, Sira: 65 },
    ];
