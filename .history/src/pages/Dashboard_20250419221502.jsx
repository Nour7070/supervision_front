...
const Dashboard = ({ userType }) => {
  ...
  className="h-4 w-4 border border-[#FACC15] rounded bg-white text-[#FACC15] 
            focus:ring-1 focus:ring-[#FACC15] focus:ring-offset-0 
            checked:bg-[#FACC15] checked:border-[#FACC15] 
