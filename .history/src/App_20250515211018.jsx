...
// Composant d'enveloppe pour le Dashboard qui gère les paramètres de route
const DashboardWrapper = () => {
  const { userType, userId } = useParams();
  
  if (userType.toLowerCase() === 'superviseur') {
    return <Dashboard userType="SUPERVISEUR" userId={userId} />;
  } else if (userType.toLowerCase() === 'moderateur') {
...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<Layout userType={userType} onLogout={() => {}} />}>
          {/* Route pour les tableaux de bord avec un wrapper qui gère les paramètres */}
          <Route path="/:userType/:userId/dashboard" element={<DashboardWrapper />} />
