 ...
 /* <Route
  ...
  function App() {
    ...
    const DashboardSwitcher = () => {
      ...
      if (userType === "superviseur") return <Dashboard userType="SUPERVISEUR" />;
      if (userType === "moderateur") return <DashboardMod userType="MODERATEUR" />;
      
      return <div className="p-8 text-center text-red-500">Type d'utilisateur inconnu</div>;
    };
    return (
      <Router>
       <Routes>
  <Route path="dashboard/:userType" element={<Layout onLogout={() => {}} />}>
