...
import {  CartesianGrid, Tooltip, Legend, 
...
const UserStat = () => {
    ...
    const getFormateurChartData = () => {
        ...
        const pieData = [
            { name: 'Courses approved', value: stats.coursPublies, color: '#057652' },
            { name: 'Courses pending', value: stats.coursEnAttente, color: '#FCE173' }
        ];
        const progressData = [
