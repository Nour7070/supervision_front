                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-2 space-y-3">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#CBE2D7] text-white py-2.5 rounded-lg hover:from-teal-700 hover:to-teal-600 transition-all shadow-md flex items-center justify-center"
                        >
                            {loading ? (
