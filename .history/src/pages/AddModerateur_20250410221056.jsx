        ...
        <div className="flex items-center justify-center min-h-screen bg-white-100 p-4">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="block text-white-700 font-medium mb-2">Nom</label>
                        <input
                            type="text"
                            value={nom}
                    ...
                    <div className="mb-4">
                        <label className="block text-white-700 font-medium mb-2">Prénom</label>
                        <input
                            type="text"
                            value={prenom}
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg w-full max-w-md">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">Ajouter un Modérateur</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-2 space-y-3">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-teal-600 to-teal-500 text-white py-2.5 rounded-lg hover:from-teal-700 hover:to-teal-600 transition-all shadow-md flex items-center justify-center"
                        >
                            {loading ? (
