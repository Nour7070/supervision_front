                                        ...
                                        <div key={request.id} className="border-b pb-3 last:border-0">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-1 bg-[#FACC15] text-black rounded hover:bg-blue-600 "
                                                >
                                                    Voir demande
                                                </button>
                                            </div>
                                        ...
                                        <div key={course.id} className="border-b pb-3 last:border-0">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-1 bg-[#FCE173] text-black rounded hover:bg-blue-600 "
                                                >
                                                    Voir demande
                                                </button>
                                            </div>
