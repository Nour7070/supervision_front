...
>
    ...
    <div className="absolute left-0 top-0 h-1/2 w-1/4 overflow-hidden z-0">
        <img 
            src="/images/Subtract.png" 
            alt="Décoration haut gauche"
            className="h-full w-full object-cover object-right-bottom"
            style={{
                transform: 'translateX(-20%) rotate(-100g)',
                opacity: 0.7
            }}
        />
    </div>

    <div className="absolute right-0 bottom-0 h-1/2 w-1/4 overflow-hidden z-0">
        <img 
            src="/images/Subtract.png" 
