...
const UsersList = ({ userType }) =>
{
    ...
    return (
        <div className="relative min-h-screen w-full">
            {/* Image d'arrière-plan qui prend tout l'espace disponible */}
            <div
                className="absolute inset-0 z-0"
                style={{
                    backgroundImage: 'url(/images/coran.jpg)',
            ...
            {/* Contenu principal sans padding sur les bords */}
            <div className="relative z-10 w-full h-full">
                <div className="max-w-6xl mx-auto h-full">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mt-6 mx-4">
