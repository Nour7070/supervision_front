...
/*const handlePreviewFile = (fileUrl) => {
  ...
  <div className="h-[272px] overflow-y-auto scrollbar scrollbar-thumb-green-500 scrollbar-track-gray-100 scrollbar-thumb-rounded-full pr-4">
      <AnimatePresence>
...
<div className="bg-white p-4 rounded-lg shadow-sm">
  ...
  <div className="relative">
  <div className="h-[272px] overflow-y-auto scrollbar scrollbar-thumb-[#034732] scrollbar-track-gray-100 scrollbar-thumb-rounded-full pr-4">
      <AnimatePresence>
        <motion.div className="space-y-3" {...animationProps}>
