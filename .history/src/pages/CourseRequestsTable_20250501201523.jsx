...
const CourseRequestsTable = () => {
  ...
  return (
    <div className="w-full h-full fixed inset-0 overflow-auto" 
      style={{
      ...
      <div className="flex-1 p-8 overflow-auto pt-24"> {/* Add padding-top to account for header */}
        <h1 className="text-3xl font-bold text-[#034732] mb-8 text-center">COURSE PUBLICATION REQUESTS</h1>
