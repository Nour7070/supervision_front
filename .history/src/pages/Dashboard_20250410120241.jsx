...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        { mois: 'Jan', informatique: 65, marketing: 45, finance: 30, design: 25, langues: 20 },
        { mois: 'Fév', informatique: 70, marketing: 50, finance: 35, design: 30, langues: 25 },
        { mois: 'Mar', informatique: 80, marketing: 55, finance: 40, design: 35, langues: 30 },
        { mois: 'Avr', informatique: 90, marketing: 60, finance: 45, design: 40, langues: 35 },
        { mois: 'Mai', informatique: 85, marketing: 65, finance: 50, design: 45, langues: 40 },
        { mois: 'Juin', informatique: 95, marketing: 70, finance: 55, design: 50, langues: 45 },
        { mois: 'Juil', informatique: 100, marketing: 75, finance: 60, design: 55, langues: 50 },
        { mois: 'Août', informatique: 90, marketing: 65, finance: 50, design: 45, langues: 45 },
        { mois: 'Sep', informatique: 110, marketing: 80, finance: 65, design: 60, langues: 55 },
        { mois: 'Oct', informatique: 120, marketing: 85, finance: 70, design: 65, langues: 60 },
        { mois: 'Nov', informatique: 115, marketing: 80, finance: 65, design: 60, langues: 55 },
        { mois: 'Déc', informatique: 130, marketing: 90, finance: 75, design: 70, langues: 65 },
    ];
        ...
        return (
            <div className="p-6 bg-gray-50 min-h-screen">
                <div className="bg-white p-8 rounded-lg shadow-lg mb-6">
                    ...
                    <InscriptionsByDomaineChart data={data} colors={colors} />
