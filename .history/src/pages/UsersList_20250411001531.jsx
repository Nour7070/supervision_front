...
const UsersList = ({ userType }) =>
{
    ...
    return (
        <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
            <div
                className="p-4 md:p-8 min-h-screen bg-gray-50 relative"
                style={{
                    backgroundImage: 'url(/home/nour/Bureau/front-sup/public/images/image.jpg)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}
            >
                {/* Couche semi-transparente par-dessus l'image de fond */}
                <div className="absolute inset-0 bg-white bg-opacity-80"></div>

                {/* Contenu de la page (mettre en position relative pour qu'il apparaisse au-dessus) */}
