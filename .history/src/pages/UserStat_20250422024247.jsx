...
const [events, setEvents] = useState([
    { date: new Date(), title: "Exemple d'événement" },
    ...
    const getFormateurChartData = () => {
        ...
        const pieData = [
            { name: 'Cours publiés', value: stats.coursPublies, color: '#057652' },
            { name: 'Cours en attente', value: stats.coursEnAttente, color: '#FCE173' }
        ];
        const progressData = [
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 h-full">
            ...
            <div className="h-80">
                <DatePicker
                    ...
                    calendarClassName="border-0 w-full h-full"
                />
                <div className="mt-4">
