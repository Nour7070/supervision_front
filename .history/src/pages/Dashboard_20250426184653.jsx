...
/*const handlePreviewFile = (fileUrl) => {
  ...
  {/* Section Formateurs */}
  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
    <h2 className="text-base font-semibold mb-3">Trainer Moderation Actions</h2>
    <div className="h-[272px] overflow-y-auto">
      {trainerActivities.map((action, index) => (
        <div key={index} className="border-b pb-3 last:border-0">
          {/* Votre code d'affichage existant */}
          <p>{action.description}</p>
          <p>Modérateur: {action.moderatorName}</p>
        </div>
      ))}
    </div>
  </div>
  ...
  {/* Section Cours */}
  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
    <h2 className="text-base font-semibold mb-3">Course Moderation Actions</h2>
    <div className="h-[272px] overflow-y-auto">
      {courseActivities.map((action, index) => (
        <div key={index} className="border-b pb-3 last:border-0">
          {/* Votre code d'affichage existant */}
          <p>{action.description}</p>
          <p>Modérateur: {action.moderatorName}</p>
