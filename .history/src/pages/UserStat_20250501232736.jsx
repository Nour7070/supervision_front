...
>
    ...
    <div className="absolute left-2 top-2 h-16 w-16 overflow-hidden z-0 opacity-60">
        <img 
    ...
    <div className="absolute right-2 bottom-2 h-16 w-16 overflow-hidden z-0 opacity-60">
        <img 
            src="/images/Subtract.png" 
            alt=""
            className="h-full w-full object-contain"
