  ...
  const fetchCourses = async () => {
    try {
      ...
      const formattedCourses = response.data.map(c => ({
        ...
        formateurName: c.formateurNomComplet || `Trainer ${c.formateurId}`,
  ...
  return (
        <div className="flex h-screen bg-gray-100">
          ...
          <div className="relative z-10 flex-1 p-8 overflow-auto">
            <h1 className="text-3xl font-bold text-[#034732] mb-8 text-center">COURSES PUBLICATIONS REQUESTS</h1>
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="relative z-10 flex-1 p-8 overflow-auto">
        ...
        <div className="max-w-full mx-auto bg-white/90 backdrop-blur-sm p-8 rounded-xl border border-gray-300 shadow-lg">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
          ...
          {courses.length > itemsPerPage && (
            <div className="mt-4 px-6 py-3 bg-white border-t border-gray-200">
              <ReactPaginate
                ...
                activeLinkClassName="bg-gray-200 text-gray-900 font-medium"
