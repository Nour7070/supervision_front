...
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import axios from 'axios';  // Si tu utilises axios pour les appels API
...
const InscriptionDomaine = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`/api/courses/stats?year=${activeYear}`)
      .then((response) => {
        // Transforme les données reçues en format compatible avec le graphique
