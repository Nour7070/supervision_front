...
const UsersList = ({ userType }) =>
{
    ...
    return (
        <div className="relative w-full min-h-screen overflow-hidden">
          {/* Image de fond pleine page sans espace */}
          <div
          ...
          <div className="relative z-10 w-full h-full">
            <div className="max-w-6xl mx-auto">
              ...
              {/* Barre de recherche sans marges latérales */}
              <div className="mt-4 px-0 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
