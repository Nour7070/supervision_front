...
const simulatedUsers = [
    ...
    { id: 2, name: "Fatima", email: "Fatima@gmail.com" },
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mt-6">
                    <ReactPaginate
                        ...
                        pageLinkClassName="px-3 py-1 rounded-md text-sm font-medium text-gray-700 hover:bg-[#938A8A]"
                        previousLinkClassName="p-1 rounded-md text-gray-700 hover:bg-[#938A8A]"
                        nextLinkClassName="p-1 rounded-md text-gray-700 hover:bg-[#938A8A]"
                        activeLinkClassName="bg-[#CBE2D7] text-white hover:bg-[#938A8A]"
