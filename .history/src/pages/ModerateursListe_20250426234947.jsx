  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
       <div className="fixed inset-0 z-0 bg-cover bg-center" 
         style={{ 
           backgroundImage: 'url(/images/Screenshot_2181.png)', 
                ...
                >
                  ...
                  <td className="text-center py-3 px-4">
                    <div className="flex justify-center space-x-2">
                      ...
                      {userType === 'SUPERVISEUR' && (
                        <button
                          className="bg-whitetext-black border border-gray-400 py-1 px-3 rounded-lg hover:bg-gray-100 transition-all duration-200 flex items-center"
