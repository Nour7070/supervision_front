...
const ModerateursListe = ({ userType }) => {
  ...
  <div className="flex justify-center space-x-2">
    <button
      className="bg-gray-200 text-black p-2 rounded-lg hover:bg-gray-300 transition-all duration-200"
      onClick={() => handleViewStats(moderateur.id)}
    ...
    {userType === 'SUPERVISEUR' && (
      <button
        className="bg-red-100 text-red-600 p-2 rounded-lg hover:bg-red-200 transition-all duration-200"
