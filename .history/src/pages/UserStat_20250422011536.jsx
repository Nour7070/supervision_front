...
const itemVariants = {
  ...
  try {
    ...
    // Affichez la réponse brute avant de la parser
    ...
    let data;
    try {
      data = JSON.parse(responseText); // Utilisez le texte déjà récupéré
    } catch (jsonError) {
    ...
    // ... (garder les mêmes animations et états de chargement/erreur)
