                      ...
                      {recentActivities.length > 0 ? (
                        recentActivities.map((activity, index) => (
                          <div key={index} className="flex items-center mb-2 min-h-[60px]">
                            <div
                              className={`w-6 h-6 rounded-full mr-4 flex justify-center items-center ${
                                activity.type === 'NEW_TRAINER_TO_VALIDATE'
                                  ? 'bg-[#046244]'
                                  : activity.type === 'NEW_COURSE_TO_VALIDATE'
                                  ? 'bg-[#75B9BE]'
                                  : activity.type === 'NEW_STUDENT_SIGNUP'
                                  ? 'bg-[#FBD84B]'
                                  : 'bg-gray-400'
                              }`}
                            >
