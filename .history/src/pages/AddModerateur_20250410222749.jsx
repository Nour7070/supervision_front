                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full pl-10 pr-3 py-2 border border-black rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-700 transition-all duration-300 ease-in-out"
                                required
                            />
                        </div>
                    </div>
