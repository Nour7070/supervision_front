          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <header className="bg-white shadow-sm">
              <div className="max-w-6xl mx-auto px-4 py-4">
                ...
                <p className="text-gray-500 mt-2">Access management</p>
              </div>
            </header>
      
            {/* Zone de contenu avec image de fond */}
            <div className="flex-1 overflow-auto relative">
              {/* Image de fond (uniquement ici) */}
              <div
                className="absolute inset-0 z-0"
                style={{
                  backgroundImage: 'url(/images/ph4.jpg)',
              ...
              <div className="relative z-10 h-full">
                <div className="max-w-6xl mx-auto px-4 py-4">
                  ...
                  <div className="mt-4">
                    {filteredUsers.length > 0 ? (
                      <div className="bg-white bg-opacity-90 rounded-xl shadow-sm overflow-hidden border border-gray-200">
                      ...
                      <div className="bg-white bg-opacity-90 rounded-lg shadow-sm p-8 text-center border border-gray-200">
