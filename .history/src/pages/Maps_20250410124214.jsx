...
// Données d'exemple - associe le code ISO du pays avec le nombre d'utilisateurs
const countryData = {
  USA: 4200, FRA: 2500, MAR: 1800, EGY: 3100, SAU: 2700,
  ARE: 1500, IDN: 2200, MYS: 1300, GBR: 1900, DEU: 1600,
  CAN: 1400, AUS: 1100, BRA: 950, ZAF: 850, IND: 2000,
...
export default 
  ...
  // Palette de couleurs verte à différentes intensités (comme dans votre image)
  const colorScale = d3.scaleSequential()
    .domain([0, 5000])
    .interpolator(d3.interpolateGreens);
    
  // Fonction pour gérer le survol des pays
