  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      <ReactPaginate
        ...
        activeClassName={'bg-[#CBE2D7] text-white'}
        activeLinkClassName={'bg-[#CBE2D7] text-white px-4 py-2 rounded-lg'}
        previousClassName={'mr-2'}
        previousLinkClassName={'bg-[#CBE2D7] text-white px-4 py-2 rounded-lg hover:bg-teal-600'}
        nextClassName={'ml-2'}
