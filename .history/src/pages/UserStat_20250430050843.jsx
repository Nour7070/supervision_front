...
const UserStat = () => {
    ...
    return (
        <div className="bg-gray-50 min-h-screen py-8">
            ...
            >
            <motion.div 
    className="relative rounded-xl shadow-lg p-6 mb-8 overflow-hidden border-2 border-[#FACC15] transition-all duration-300 hover:shadow-2xl"
    variants={itemVariants}
    whileHover={{ scale: 1.01 }}
>
    <div className="absolute inset-0 bg-gradient-to-r from-[#034732]/90 to-[#056349]/80 z-0"></div>
    
    {/* Image positionnée à l'extrême droite et coupée à moitié */}
    <div className="absolute right-0 top-0 h-full w-1/2 overflow-hidden z-0">
        <img 
            src="/images/Subtract.png" 
            alt="" 
            className="h-full opacity-80"
            style={{ 
                marginLeft: '-50%', // Pour couper l'image à moitié
                transform: 'translateX(30%)' // Ajustement fin de la position
            }}
        />
    </div>
    ...
    <div className="relative z-10">
        <div className="flex flex-col items-center text-center">
            ...
            {/* Suppression de la div avec le trait jaune */}
            <p className="text-white/80 mt-1">{stats?.email}</p>
