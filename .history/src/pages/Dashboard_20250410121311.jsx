...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        ...
        { mois: 'Juin', Fiqh: 80, Ahkam: 50, History: 55, Quran: 50, Sira: 45 },
        { mois: 'Juil', Fiqh: 100, Ahkam: 75, History: 60, Quran: 55, Sira: 50 },
        { mois: 'Août', Fiqh: 90, Ahkam: 65, History: 50, Quran: 45, Sira: 45 },
        { mois: 'Sep', Fiqh: 120, Ahkam: 90, History: 65, Quran: 60, Sira: 55 },
        { mois: 'Oct', Fiqh: 70, Ahkam: 65, History: 70, Quran: 65, Sira: 60 },
        { mois: 'Nov', Fiqh: 90, Ahkam: 45, History: 65, Quran: 60, Sira: 55 },
