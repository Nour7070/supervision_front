    ...
    const fetchModerateurs = async () =>
    {
      try
      {
        ...
        const simulatedModerateurs = [
          ...
          { id: 5, nom: 'Bouhail Med Ryad', email: 'RyadBhl@gmail.com', permissions: ['View', 'Edit'] },
          { id: 6, nom: 'Guenatri Lylia', email: 'LyliaGnt@gmail.com', permissions: ['View'] },
          { id: 7, nom: 'Hamouti Naila', email: 'NailaHm@gmail.com', permissions: ['View', 'Delete'] },
          { id: 8, nom: 'Boudjemaa Nazim', email: 'NazimBdj@gmail.com', permissions: ['View', 'Delete'] },
        ];
