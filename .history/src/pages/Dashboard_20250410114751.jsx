    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start">
        ...
        <div className="flex-1">
          <p className="font-medium">Nouveau formateur ajouté</p>
          <p className="text-gray-500 text-sm">John Doe • Il y a 2 heures</p>
        </div>
      ...
      <div className="flex items-start">
        <div className="bg-green-100 p-2 rounded-full mr-3">
          <i className="fas fa-graduation-cap text-green-500 text-sm"></i>
        </div>
        <div className="flex-1">
          <p className="font-medium">Nouvel apprenant inscrit</p>
          <p className="text-gray-500 text-sm">Alice Smith • Il y a 5 heures</p>
        </div>
        <span className="text-sm text-gray-400">+1</span>
      </div>
      ...
      <div className="flex items-start">
        <div className="bg-orange-100 p-2 rounded-full mr-3">
          <i className="fas fa-book text-orange-500 text-sm"></i>
        </div>
        <div className="flex-1">
          <p className="font-medium">Nouveau quiz créé</p>
          <p className="text-gray-500 text-sm">Marketing Digital • Il y a 1 jour</p>
        </div>
        <span className="text-sm text-gray-400">+1</span>
      </div>
      ...
      <div className="flex items-start">
        <div className="bg-purple-100 p-2 rounded-full mr-3">
          <i className="fas fa-shield-alt text-purple-500 text-sm"></i>
        </div>
        <div className="flex-1">
          <p className="font-medium">Action modérateur</p>
          <p className="text-gray-500 text-sm">Contenu modéré • Il y a 2 jours</p>
        </div>
        <span className="text-sm text-gray-400">+1</span>
      </div>
    </div>
