...
const Layout = ({ onLogout }) =>
{
  ...
  return (
    <div className="flex h-screen bg-white-100">
      {/* Sidebar - Desktop */}
      <div className={`hidden md:flex md:flex-shrink-0 ${sidebarOpen ? 'w-64' : 'w-20'} bg-white-700 transition-all duration-300 flex-col`}>
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="px-2 py-4">
            ...
            {/* Exemple conditionnel pour SUPERVISEUR */}
