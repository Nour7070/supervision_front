...
const Dashboard = ({ userType }) =>
{
    ...
    const data = [
        { mois: 'Jan', Fiqh: 65, Ahkam: 45, History: 100, Quran: 25, Sira: 20 },
        { mois: 'Fév', Fiqh: 70, Ahkam: 50, History: 10, Quran: 30, Sira: 25 },
        { mois: 'Mar', Fiqh: 90, Ahkam: 100, History: 45, Quran: 35, Sira: 30 },
        { mois: 'Avr', Fiqh: 50, Ahkam: 70, History: 47, Quran: 40, Sira: 35 },
        { mois: 'Mai', Fiqh: 102, Ahkam: 120, History: 70, Quran: 45, Sira: 40 },
        { mois: 'Juin', Fiqh: 80, Ahkam: 50, History: 80, Quran: 50, Sira: 45 },
        { mois: 'Juil', Fiqh: 100, Ahkam: 75, History: 30, Quran: 55, Sira: 50 },
        { mois: 'Août', Fiqh: 90, Ahkam: 65, History: 50, Quran: 45, Sira: 45 },
        { mois: 'Sep', Fiqh: 120, Ahkam: 90, History: 65, Quran: 60, Sira: 55 },
        { mois: 'Oct', Fiqh: 70, Ahkam: 65, History: 90, Quran: 65, Sira: 60 },
        { mois: 'Nov', Fiqh: 90, Ahkam: 45, History: 100, Quran: 60, Sira: 55 },
        { mois: 'Déc', Fiqh: 50, Ahkam: 90, History: 75, Quran: 70, Sira: 65 },
    ];
