    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 bg-gray-50"
          style={{
            height: 'calc(100vh - 4rem)', // 4rem = hauteur du header (h-16)
            marginLeft: sidebarOpen ? '16rem' : '5rem', // Ajustez selon la largeur de votre sidebar
            transition: 'margin-left 0.3s ease' // Pour une animation fluide
          }}>
