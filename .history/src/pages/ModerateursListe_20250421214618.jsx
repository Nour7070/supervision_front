...
import { FiSearch, FiUserPlus, FiBarChart2, FiChevronUp,FiChevronLeft, FiChevronRight, FiChevronDown } from 'react-icons/fi';
...
const ModerateursListe = ({ userType }) =>
{
  ...
  <thead className="bg-gray-50">
    <tr>
      ...
      {contextMenu && (
        <div
          className="context-menu absolute bg-gray-200 border border-gray-200 shadow-lg rounded-lg z-50"
