...
>
    <div className="absolute inset-0 bg-gradient-to-r from-[#034732]/90 to-[#056349]/80  border-3 border-[#FACC15} z-0"></div>
    
    <img 
        src="/images/Subtract" 
        alt="Decoration"
        className="absolute right-0 top-0 h-full opacity-20 z-0"
    />
