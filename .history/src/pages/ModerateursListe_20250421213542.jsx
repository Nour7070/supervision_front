  ...
  <thead className="bg-gray-50">
    <tr>
      ...
      <ReactPaginate
        ...
        pageClassName={'mx-1'}
        pageLinkClassName={'px-4 py-2 border border-gray-600 rounded-lg hover:bg-gray-200'}
        activeClassName={'bg-gray-200 text-black'}
        activeLinkClassName={'bg-gray-200 text-black px-4 py-2 rounded-lg'}
        previousClassName={'mr-2'}
        previousLinkClassName={'bg-gray-200 text-black px-4 py-2 rounded-lg hover:bg-gray-500'}
        nextClassName={'ml-2'}
        nextLinkClassName={'bg-gray-200 text-black px-4 py-2 rounded-lg hover:bg-gray-500'}
      ...
      {userType === 'SUPERVISEUR' && (
        <div className="mt-6 text-center">
          <Link
            to="/moderateurs/add"
            className="bg-gray-200 text-black py-2 px-6 rounded-lg hover:bg-[#938A8A] shadow-md hover:shadow-lg transition-all duration-200 inline-flex items-center"
          >
