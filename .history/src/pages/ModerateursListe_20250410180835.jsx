    ...
    const fetchModerateurs = async () =>
    {
      try
      {
        ...
        const simulatedModerateurs = [
          { id: 1, nom: 'Bouhail Med Ryad', email: 'Ryad@gmail.com', permissions: ['View', 'Edit'] },
          { id: 2, nom: 'Jane Smith', email: 'jane@gmail.com', permissions: ['View'] },
          { id: 3, nom: 'Alice Johnson', email: 'alice@gmail.com', permissions: ['View', 'Delete'] },
        ];
