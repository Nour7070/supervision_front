...
const ModerateurStats = () =>
{
  ...
  if (loading) return <p className="text-center text-gray-500">Chargement des statistiques...</p>;
      ...
      <div className="bg-white shadow-md rounded-lg p-4 mb-6">
        ...
        <ul className="list-disc pl-6">
          {stats.actions && stats.actions.length > 0 ? (
            ...
            <li className="text-gray-500">Aucune action récente</li>
          )}
        </ul>
      </div>
          ...
          {stats.cours && stats.cours.length > 0 ? (
            stats.cours.map((cours, index) => (
              <li key={index} className="text-gray-700">
                ...
                <span className="text-sm text-gray-500">Enseignant : {cours.enseignant}</span>
              </li>
            ))
          ) : (
            <li className="text-gray-500">Aucun cours validé ou refusé</li>
          )}
        </ul>
      </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-4">
        ...
        <ul className="list-disc pl-6">
          {stats.plaintes && stats.plaintes.length > 0 ? (
            ...
            <li className="text-gray-500">Aucune plainte en cours</li>
          )}
        </ul>
      </div>
    </div>
