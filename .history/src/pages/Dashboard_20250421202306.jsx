    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                const moderateurs = data.moderateurs;
                const averageCoursesPerTrainer = data.averageCoursesPerTrainer;
                    ...
                    <div className="bg-white rounded-lg shadow p-6 flex items-start">
                        ...
                        <div className="bg-white rounded-lg shadow p-6 flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold">{stats.averageCoursesPerTrainer}</p>
